...
export interface IServicioService {
  ...
  update(id: string, data: { nombre?: string; duracion?: number; precio?: number; requiereSeña?: boolean; porcentajeSeña?: number }, proveedorId: string): Promise<ServicioEntity>;
